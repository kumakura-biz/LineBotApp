        ...
        switch (state.step) {
          ...
          case 2:
            ...
            await replyQuickReply(replyToken, "どんな気分で整いたいですか？", [
              { label: "リフレッシュ", text: "リフレッシュしたい、頭を空っぽにしたい、仕事や人間関係のストレスを流したい、気分を切り替えたい、マッサージをしたい" },
              { label: "ゆったり静か", text: "ゆったり静かに癒されたい、ゆったり静かに過ごしたい、混雑してない場所でのんびりしたい" },
              { label: "ガチ勢", text: "高温・灼熱系でガッツリととのいたい、水風呂のキンキン具合重視、サウナハット持参で本気モード" },
              { label: "グループ", text: "グループで楽しみたい、友人とおしゃべり、カップル・夫婦でリラックス、サウナ仲間との“サ活”会" },
              { label: "プライベート", text: "プライベートサウナでサウナを独り占め" },
              { label: "自然・景色", text: "自然や景色を感じたい、外気浴で風を感じたい、自然の中のサウナに行きたい（川サウナ・湖畔サウナなど）、星空や夕日を眺めたい" },
